...
if os == 3:
           ...
           print """
#-------------------#--Name--------------#
|[0] Virus          | Linux.Wirenet      |
|[1] Ransomware     | Linux.Encoder.1    |
|[2] Ransomware     | Rex                |
#-------------------#--------------------#
"""
           virl = input("malwd0wn> ")
           if virl == 0:
                        print"[*] Downloading..."
                        subprocess.call(['./bin/linux/vir.sh'])
           if virl == 1:
                        print"[*] Downloading..."
                        subprocess.call(['./bin/linux/ransom.sh'])
           if virl == 2:
                        print"[*] Downloading..."
                        subprocess.call(['./bin/linux/ransom1.sh'])
if os == 4:
